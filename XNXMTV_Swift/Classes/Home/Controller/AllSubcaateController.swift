...
private let kSubcataCellID: String = "XNCollectionSubcateCell"
...
class AllSubcaateController: UIViewController {
    ...
    fileprivate lazy var selectedChannels = [XNGameModel]()   // 已选择的频道
    ...
    fileprivate lazy var collectionView: UICollectionView = { [unowned self] in
        ...
        collectionView.register(UINib(nibName: "XNCollectionSubcateCell", bundle: nil), forCellWithReuseIdentifier: kSubcataCellID)
...
extension AllSubcaateController {
    ...
    fileprivate func requestData() {
        ...
        XNNetworkTool.reqeust(type: .GET, urlString: "http://api.m.panda.tv/ajax_get_all_subcate", paramters: ["__version":"1.1.7.1305", "__plat":"ios", "__channel":"appstore"]) { (result) in
            // 将result 转成字典
...
extension AllSubcaateController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kSubcataCellID, for: indexPath) as! XNCollectionSubcateCell
