...
protocol XNPageTitleViewDelegate: class {
...
class XNPageTitleView: UIView {

    weak var delegate : XNPageTitleViewDelegate?
...
extension XNPageTitleView {
    ...
    fileprivate func setupTitleLabels() {
        ...
        for (index,title) in titles.enumerated() {
            ...
            label.textColor = UIColor(r: kNormalColor.0, g: kNormalColor.0, b: kNormalColor.2)
...
extension XNPageTitleView {
    @objc fileprivate func titleLabelClick(_ tapGes:UITapGestureRecognizer){
        ...
        scrollView.frame.size.width = currentLabel.frame.width * 0.8
